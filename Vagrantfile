...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "nickprot-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/engagepoint"
  #   chef.validation_client_name = "engagepoint-validator"
  #   chef.validation_key_path = ".chef/engagepoint-validator.pem"
  # end
end
